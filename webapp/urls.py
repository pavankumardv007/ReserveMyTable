...
urlpatterns = [
    ...
    path('edit_details/<int:id>',views.edit_restaurant_details,name="edit"),
    path('edit_menu/<int:id>',views.edit_restaurant_menu,name="edit"),
    path('edit_profile/<int:id>',views.edit_restaurant_profile,name="edit"),
